 ...
 */
class Gt_Gtbanner_Helper_Image extends Mage_Core_Helper_Abstract
{
    protected $_model;
    ...
    {
        $this->_reset();
        $this->_setModel(Mage::getModel('gtbanner/banner_image'));
     ...
     *
     * @see Gt_Gtbanner_Model_Banner_Image
     * @param int $width
     * @param int $height
     * @return Gt_Gtbanner_Helper_Image
     */
