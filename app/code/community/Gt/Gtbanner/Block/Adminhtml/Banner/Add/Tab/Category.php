...
/**
 * Banner categories tab
 *
 * @category   Gt
 * @package    Gt_Gtbanner
 * @author     Gentotech <http://www.gentotech.com/>
 */
class Gt_Gtbanner_Block_Adminhtml_Banner_Add_Tab_Category extends Mage_Adminhtml_Block_Catalog_Category_Tree
{
    ...
    {
        parent::__construct();
        $this->setTemplate('gt_gtbanner/edit/tab/category.phtml');
    }
...
//        }
    ...
    public function getCategoryChildrenJson($categoryId)
    {
        ...
        return Mage::helper('gtbanner')->jsonEncode($children);
    }
