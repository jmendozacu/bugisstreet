 ...
 */
class Gt_Gtbanner_Block_Adminhtml_Banner_Edit_Tab_Image extends Mage_Adminhtml_Block_Widget {
    ...
    public function __construct() {
        parent::__construct();
        $this->setTemplate('gt_gtbanner/edit/tab/image.phtml');
        ...
        if (is_array($_data) and sizeof($_data) > 0) {
            ...
            foreach ($_data as &$_item) {
                $_result[] = array(
                    ...
                    'url'       => Mage::getSingleton('gtbanner/config')->getBaseMediaUrl() . $_item['file'],                    
                    'file'      => $_item['file'],
                    'label'     => $_item['label'],
    ...
    public function getImageTypes() {
        $type = array();
        $type['gallery']['label'] = "gtbanner";
        $type['gallery']['field'] = "gtbanner";
