 ...
 */
class Gt_Gtbanner_Model_Banner_Image extends Mage_Core_Model_Abstract
{
    protected $_width;
    protected $_height;
    ...
    {
        $this->_init('gtbanner/banner_image');
    }

    /**
     * @return Gt_Gtbanner_Model_Banner_Image
     */
...
//        print '$this->_getNeedMemoryForBaseFile() = '.$this->_getNeedMemoryForBaseFile();
    ...
    public function setBaseFile($file)
    {
        ...
        $baseDir = Mage::getSingleton('gtbanner/config')->getBaseMediaPath();
...
//            }
    ...
    public function clearCache()
    {
        ...
        $directory = Mage::getSingleton('gtbanner/config')->getBaseMediaPath() .DS.'cache'.DS;
