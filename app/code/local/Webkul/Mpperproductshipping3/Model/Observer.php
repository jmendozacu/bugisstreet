...
Class Webkul_Mpperproductshipping3_Model_Observer
{
	public function afterPlaceOrder($observer) { 
		...
		if(strpos($shippingmethod,'mpperproductshipping3')!==false){
			...
			foreach($shippingAll['mpperproductshipping3'] as $shipdata){
