<?php
class Webkul_Mpshippingmanager_Adminhtml_Mpshippingmanager_OrdermanageController extends Mage_Adminhtml_Controller_Action
{
    ...
    public function gridAction(){
            $this->loadLayout();
            $this->getResponse()->setBody($this->getLayout()->createBlock("mpshippingmanager/adminhtml_ordermanage_grid")->toHtml()); 
        }
