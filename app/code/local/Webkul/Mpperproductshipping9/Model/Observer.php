...
Class Webkul_Mpperproductshipping9_Model_Observer
{
	public function afterPlaceOrder($observer) { 
		...
		if(strpos($shippingmethod,'mpperproductshipping9')!==false){
			...
			foreach($shippingAll['mpperproductshipping9'] as $shipdata){
