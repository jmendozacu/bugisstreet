...
Class Webkul_Mpperproductshipping6_Model_Observer
{
	public function afterPlaceOrder($observer) { 
		...
		if(strpos($shippingmethod,'mpperproductshipping6')!==false){
			...
			foreach($shippingAll['mpperproductshipping6'] as $shipdata){
