...
class Webkul_Marketplace_Adminhtml_Marketplace_PartnersController extends Mage_Adminhtml_Controller_Action
{
	...
	public function denyAction(){
		...
		$this->_getSession()->addSuccess($sellername.Mage::helper('marketplace')->__(' has been successfully denied to become seller'));
    ...
    public function printstatementAction(){
        Mage::getModel('marketplace/userprofile')->massprintstate($this->getRequest());
        //$this->_getSession()->addSuccess(Mage::helper('marketplace')->__('Seller has been successfully unapproved'));
        $this->_redirect('adminhtml/marketplace_partners/');
    }

    public function printrefundlistingAction(){
        Mage::getModel('marketplace/userprofile')->massprintrefund($this->getRequest());
       // $this->_getSession()->addSuccess(Mage::helper('marketplace')->__('Seller has been successfully unapproved'));
        $this->_redirect('adminhtml/marketplace_partners/');
    }
