...
Class Webkul_Mpperproductshipping10_Model_Observer
{
	public function afterPlaceOrder($observer) { 
		...
		if(strpos($shippingmethod,'mpperproductshipping10')!==false){
			...
			foreach($shippingAll['mpperproductshipping10'] as $shipdata){
