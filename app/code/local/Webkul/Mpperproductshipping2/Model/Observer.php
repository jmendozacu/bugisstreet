...
Class Webkul_Mpperproductshipping2_Model_Observer
{
	public function afterPlaceOrder($observer) { 
		...
		if(strpos($shippingmethod,'mpperproductshipping2')!==false){
			...
			foreach($shippingAll['mpperproductshipping2'] as $shipdata){
