...
Class Webkul_Mpperproductshipping4_Model_Observer
{
	public function afterPlaceOrder($observer) { 
		...
		if(strpos($shippingmethod,'mpperproductshipping4')!==false){
			...
			foreach($shippingAll['mpperproductshipping4'] as $shipdata){
