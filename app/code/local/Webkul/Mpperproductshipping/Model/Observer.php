...
Class Webkul_Mpperproductshipping_Model_Observer
{
	public function afterPlaceOrder($observer) { 
		...
		if(strpos($shippingmethod,'mpperproductshipping')!==false){
			...
			foreach($shippingAll['mpperproductshipping'] as $shipdata){
