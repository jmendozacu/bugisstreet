...
Class Webkul_Mpperproductshipping8_Model_Observer
{
	public function afterPlaceOrder($observer) { 
		...
		if(strpos($shippingmethod,'mpperproductshipping8')!==false){
			...
			foreach($shippingAll['mpperproductshipping8'] as $shipdata){
