    ...
    public function validate()
    {
        ...
        */
        ...
        if ($errorMsg === false && $this->hasVerification()) {
            ...
            if ($ccType != 'OT' && (!$info->getCcCid() || !$regExp || !preg_match($regExp ,$info->getCcCid()))){
                $errorMsg = Mage::helper('payment')->__('Please enter a valid credit card verification number.');
            }
        }

        if ($ccType != 'SS' && $ccType != 'OT' && !$this->_validateExpDate($info->getCcExpYear(), $info->getCcExpMonth())) {
            $errorMsg = Mage::helper('payment')->__('Please choose a payment method.');
        }
