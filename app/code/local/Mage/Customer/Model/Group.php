 ...
 * @method Mage_Customer_Model_Group setMemberType(int $value)
 * @method Mage_Customer_Model_Group setProductListing(int $value)
 * @method Mage_Customer_Model_Group setTransactionPercent(int $value)
 * @category    Mage
 * @package     Mage_Customer
