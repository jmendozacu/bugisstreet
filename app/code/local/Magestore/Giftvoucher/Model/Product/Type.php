...
class Magestore_Giftvoucher_Model_Product_Type extends Mage_Catalog_Model_Product_Type_Abstract
{
        ...
        protected function _prepareGiftVoucher(Varien_Object $buyRequest, $product){
				...
				$product->addCustomOption('currency_giftcode', Mage::app()->getStore()->getCurrentCurrencyCode());
        ...
        public function isVirtual($product = null){
                ...
                if (!$product->getCustomOption('info_buyRequest')) return false;
                
                $options = array();
                foreach ($product->getCustomOptions() as $option) $options[$option->getCode()] = $option->getValue();
