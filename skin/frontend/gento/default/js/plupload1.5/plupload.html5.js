        ...
        getFeatures: function () {
            ...
            s.bind("Init", function (A) {
                ...
                if (A.features.triggerDialog) {
                    l.extend(I.style, {position: "absolute", width: "100%", height: "100%"})
                } else {
                    l.extend(I.style, {cssFloat: "right", styleFloat: "right"})
                }
                ...
                if (J) {
                    var C = A.settings.browse_button_hover, E = A.settings.browse_button_active, B = A.features.triggerDialog ? J : K;
                    if (C) {
