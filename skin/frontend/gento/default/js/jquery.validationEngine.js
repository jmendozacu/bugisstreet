         ...
         var methods = {
                 ...
                 */
                 init: function(options) {
                         ...
                         if (!form.data('jqv') || form.data('jqv') == null ) {
                                 ...
                                 $(".powermail_fieldwrap").on("click", ".formError", function() {
                ...
                */
                _validateField: function(field, options, skipAjaxValidation) {
                        ...
                        for (var i in rules) {
                                if (typeof (rules[i]) != "string") { continue; } // deal with what is probably frameworks conflict - yh
                                console.log(rules[i]);
        ...
        return options.allrules[rules[i]].alertText;
                ...
                */
                _buildPrompt: function(field, promptText, type, ajaxed, options) {
                        ...
                        field.parents(".ui-select").addClass("error");
                ...
                */
                 _closePrompt: function(field) {
                        ...
                        field.parents(".ui-select").removeClass("error");
                         var prompt = methods._getPrompt(field);
                         if (prompt)
